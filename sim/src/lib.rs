...
mod tests {
    ...
    fn full_test() {
        ...
        .add_phase(|phase| {
            phase
                .update_steering(Axis::Pitch, [0., PITCH_RATES[0], 0.])
                .update_termination(|s| 25. - s.time)
        })
        .add_phase(|phase| {
            phase
                .update_steering(Axis::Pitch, [0., PITCH_RATES[1], 0.])
                .update_termination(|s| 40. - s.time)
        })
        .add_phase(|phase| {
            phase
                .update_steering(Axis::Pitch, [0., PITCH_RATES[2], 0.])
        ...
        .add_phase(|phase| {
            phase
                .update_steering(Axis::Pitch, [0., PITCH_RATES[4], 0.])
        ...
        .add_phase(|phase| {
            phase
                .update_steering(Axis::Pitch, [0., PITCH_RATES[7], 0.])
